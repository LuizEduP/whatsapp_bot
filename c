...
// -----------------------------------------------------------------------------
// NOTA: O Baileys agora usa ES Modules. Usamos import() dinâmico.
// -----------------------------------------------------------------------------
...
// Trata erros Bad MAC automaticamente
let badMACCount = 0;
...
async function startWhatsAppBot(callbacks = {}) {
    ...
    // Importa Baileys dinamicamente (ESM module)
    ...
    // Reset Bad MAC counter on new login
